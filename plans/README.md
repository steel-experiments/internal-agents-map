...
| [017](017-source-intake-pipeline.md) | Turn a list of links into a reviewed catalog record | P1 | L | 016, the schema simplification review | IMPLEMENTED 2026-09-22 on `claude/plan-017-source-intake-pipeline`; Phases 0–5 done (all twelve stages, queue runs, review sheets, run manifests, backfill apply, drift report, skill, operator doc; end-to-end and mode tests over real captures with fake services; drift schedule rejected per open decision 4); live gates — capture, backtest, judgments, acceptance, one hand drift run — blocked on API keys |
